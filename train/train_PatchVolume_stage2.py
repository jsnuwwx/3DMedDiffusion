...
def main(cfg_path: str):
    ...
    if downsample_ratio == 4:
        train_dataset = VQGANDataset_4x(
            ...
            patch_size=cfg.dataset.patch_size)  # 👈 加上这句，让数据集听从 yaml 的指挥！
        val_dataset = VQGANDataset_4x(
            root_dir=cfg.dataset.root_dir, augmentation=False, split='val', stage=2,
            patch_size=cfg.dataset.patch_size)  # 👈 这里也补上！
    else:
